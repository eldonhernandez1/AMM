...
async function main() {
  ...
  // Fetch kal Token
  const kal = await ethers.getContractAt('Token', config[chainId].kal.address)
  console.log(`kal Token fetched: ${kal.address}\n`)
