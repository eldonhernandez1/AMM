    ...
    return (
        <div className="text-white">
            <Card style={{ maxWidth: '450px' }} className="mx-auto px-4 text-black">
                {account ? (
                    <Form onSubmit={withdrawHandler} style={{ maxWidth: '450px', margin: '50px auto' }} name="Withdraw">
                        <Row>
                    ...
                    <Row>
                        <p><strong>KAL Balance: </strong>{balances[0]}</p>
                        <p><strong>DAPP Balance: </strong>{balances[1]}</p>
                    </Row>
                   </Form>
                    ...
                    <p
                        ...
                        style={{ height: '300px', fontSize: '19px' }}
                    >Connect your wallet before withdrawing tokens.</p>
                )}
            </Card>
            {isWithdrawing ? (
            <Alert
